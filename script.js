...
//         console.log(`У пользователя ${element.userName} число дизлайков составляет ${element.rating.dislikes}`);
//     }
//     if (element.userId == '5') {
//         console.log(`идентификационный номер пользователя - ${element.userId}, его описание: ${element.text}`);
//     }
// }
...
// const riddles = {
//     question: 'Кто его раздевает, тот слезы проливает',
//     answer: 'лук',
//     hints: [
//         'Репчатый',
//         'Зеленый'
...
//             alert(this.hints[0]);
//         } else {
//             return alert('Да это же победа, вы получаете аааавтомобиль');
//         }
//         if (prompt(this.question).toLowerCase() !== riddles.answer) {
//             alert(this.hints[1]);
//         } else {
...
//         }
//         if (prompt(this.question).toLowerCase() !== riddles.answer) {
//             alert('Вы проиграли, учитесь лучше');
//         } else {
//             return alert('Да это же победа, вы получаете аааавтомобиль');
//         }
//     }
